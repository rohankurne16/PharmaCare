...
<div class="page-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h2><i class="fas fa-exclamation-triangle"></i>Near to Expiry Medicines</h2>
                <p>Medicines nearing expiry date within 7 Days</p>
            </div>
            ...
            <table>
                ...
                <%
                    ArrayList<Medicine> m =
                        (ArrayList<Medicine>) session.getAttribute("expirydates");
