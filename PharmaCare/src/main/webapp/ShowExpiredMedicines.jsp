...
<div class="page-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h2><i class="fas fa-exclamation-triangle"></i> Expired Medicines</h2>
              <p>Expired Medicines – Remove or Replace Immediately</p>
            </div>
            ...
            <table>
                ...
                <%
                    ArrayList<Medicine> m =
                        (ArrayList<Medicine>) session.getAttribute("expiredmedlist");
