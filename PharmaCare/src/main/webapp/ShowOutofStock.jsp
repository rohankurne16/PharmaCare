...
<div class="page-wrapper">
    ...
    <div class="main-content">
        ...
        <div class="page-header">
            <div>
                <h2><i class="fas fa-exclamation-triangle"></i> Empty Stock </h2>
              <p>Critical Alert: No Stock Available”</p>
            </div>
            ...
            <table>
                ...
                <%
                    ArrayList<Medicine> m =
                        (ArrayList<Medicine>) session.getAttribute("outofstocklist");
                ...
                %>
                    <tr>
                        ...
                        <td data-label="Expiry Date" class="expiry">
                            <%= med.getExpiry_date() %>
                        </td>
                         <td data-label="Stocks Left"><%= med.getQuantity() %></td>
                         <td>
	                         <form action="RefillServlet" method="get">
